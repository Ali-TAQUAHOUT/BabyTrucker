...
public class BabyAdapterNanny extends RecyclerView.Adapter<BabyAdapterNanny.ViewHolder> {

    private List<Guardian> guardians;
    private Context context;

    public BabyAdapterNanny(List<Guardian> guardians, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnBaby.setOnClickListener(v -> {
            ...
            intent.putExtra("sourceFragment", "nanny");
