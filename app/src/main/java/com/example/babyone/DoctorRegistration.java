    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Add to database
                com.example.babyone.utils.DatabaseHelper.addToCollection(collectionName, registrationInfo, DoctorRegistration.this);
                Intent intent = new Intent(DoctorRegistration.this, Doctor.class);
                intent.putExtra("email", com.example.babyone.utils.AuthHelper.getCurrentUsername(DoctorRegistration.this));
