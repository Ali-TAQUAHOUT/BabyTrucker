...
public class MidWife extends AppCompatActivity {
    ...
    private BabyAdapterNanny adapter;
    private TextView welcomeNanny;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        welcomeNanny = findViewById(R.id.welcomeMidwife);
        btnLogout = findViewById(R.id.btnLogOut);

        // Get the current user
        String username = AuthHelper.getCurrentUsername(this);
        if (username != null) {
            Map<String, Object> nannyInfo = DatabaseHelper.getNannyInfo(this, username);
            if (nannyInfo != null) {
                String nannyName = (String) nannyInfo.get("name");
                welcomeNanny.setText("Welcome Back!\n Nanny " + nannyName);
            }
        }

        adapter = new BabyAdapterNanny(new ArrayList<>(), this);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (query.isEmpty()) {
                    ...
                    List<Map<String, Object>> results = DatabaseHelper.searchGuardiansByName(MidWife.this, query);
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AuthHelper.logout(MidWife.this);
    ...
    private void loadAllGuardians() {
        ...
        adapter = new BabyAdapterNanny(guardians, this);
        recyclerView.setAdapter(adapter);
