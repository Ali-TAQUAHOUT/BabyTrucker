    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String collectionName = "NannyLog";
                //Add to database
                com.example.babyone.utils.DatabaseHelper.addToCollection(collectionName, registrationInfo, MidWifeRegistration.this);
                Intent intent = new Intent(MidWifeRegistration.this, MidWife.class);
                intent.putExtra("email", com.example.babyone.utils.AuthHelper.getCurrentUsername(MidWifeRegistration.this));
