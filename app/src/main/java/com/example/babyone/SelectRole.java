    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGuardian.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start RegisterActivity with Guardian role
                Intent intent = new Intent(SelectRole.this, RegisterActivity.class);
                intent.putExtra("role", "G");
        ...
        btnDoctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Start RegisterActivity with Doctor role
                Intent intent = new Intent(SelectRole.this, RegisterActivity.class);
                intent.putExtra("role", "D");
                startActivity(intent);
            }
        });
        ...
        btnMidWife.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Start RegisterActivity with MidWife role
                Intent intent = new Intent(SelectRole.this, RegisterActivity.class);
                intent.putExtra("role", "M");
                startActivity(intent);
            }
        });
